...
# Load configuration
CONFIG_FILE="/home/ubuntu/Bash-Web-Server/config/server.conf"
...
DOCUMENT_ROOT=${DOCUMENT_ROOT:-"/home/ubuntu/Bash-Web-Server/www"}
...
ERROR_PAGES_DIR=${ERROR_PAGES_DIR:-"/home/ubuntu/Bash-Web-Server/error-pages"}
...
SCRIPTS_DIR="/home/ubuntu/Bash-Web-Server/scripts"

# Load necessary functions from the main server script
source /home/ubuntu/Bash-Web-Server/scripts/server_functions.sh
